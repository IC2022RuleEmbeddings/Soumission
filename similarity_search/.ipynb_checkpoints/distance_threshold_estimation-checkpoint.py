...
def get_measures_for_pairs(sample_pairs,model,type_distance='euclidian'):
    """
    Returns the the list of measures (distance and similarity) for all pairs.
    """
    measures = []
    for pair_ in sample_pairs:
        dist_ = get_distance_for_pair(pair_,model,type_distance=type_distance)
        sim_ = get_similarity_for_pair(pair_,model)
...
def get_similarity_for_pair(pair_,model,X,dic_functionality,type_end,PATH_TYPE,previous_node_weight=1):
    ...
    entity_0 = pair_[0]
    entity_1 = pair_[1]
#     print("Entity 0 : ",entity_0)
#     print("Entity 1 : ",entity_1)
...
#         print("Top Triples obtained : ")
#         print("For i0 : ",top_triples_i0)
#         print("For i1 : ",top_triples_i1)
